...
public class SunsetBoulevard {
    public static void main(String[] args) {
        ...
        SolicitudCredito s2 = new SolicitudCredito(prestamo2, "ACTIVA", fechaI2 , fechaF2, interesPrestamo2, 24, u1);
        System.out.println("----- SOLICITUD -----");
        System.out.println(s1.toString());
        ...
        SolicitudCredito s3 = new SolicitudCredito(prestamo3, "ACTIVA", fechaI3 , fechaF3, interesPrestamo3, 312, u2);
        System.out.println("----- SOLICITUD -----");
        System.out.println(s1.toString());
